...
public class AreaDao {
	...
	@Transactional
	public List<AreaTO> getByAreaName(String areaName,String OperatorId) {
		String hql = "from AreaModel as area where areaName='" + areaName+"'"+"and area.operatorModel.operatorId = '"+OperatorId+"'";
		
		List<AreaModel> areaModelList = sessionFactory.getCurrentSession().createQuery(hql).list();
		List<AreaTO> areaTOList = new ArrayList<AreaTO>();
		if (areaModelList != null && !areaModelList.isEmpty()) {
